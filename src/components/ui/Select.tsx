...
const Select = React.forwardRef<HTMLButtonElement, SelectProps>(({ 
    ...
    const handleOptionSelect = (option: SelectOption) => {
        if (multiple) {
            const newValue = (value as OptionValue[]) || [];
    ...
    const isSelected = (optionValue: OptionValue) => {
        if (multiple) {
            return (value as OptionValue[])?.includes(optionValue) || false;
        }
    ...
    // Normalize value for hidden native select for form submission
        ...
        <div className={cn("relative", className)}>
            ...
            <div className="relative">
                ...
                <select
                    name={name}
                    value={nativeValue}
                    onChange={() => { /* noop - controlled by custom logic */ }}
                    className="sr-only"
                    tabIndex={-1}
                    multiple={multiple}
                    required={required}
